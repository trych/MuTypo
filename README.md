# MuTypo Seminar | Scripting Session | 2019-12-05
...
- Download the [basil.js example scripts](downloads/basiljs_examples.zip), un-zip the file and move the resulting folder into the `basiljs` folder as well
...
- Download and un-zip [these setting files](downloads/ST3_settings.zip), this will result in a folder named `Sublime Text 3`
